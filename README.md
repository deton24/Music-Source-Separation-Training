...
Furthermore, no use_amp: true in at least some Roformer's yaml configs causes yaml errors (I'm not sure if you need to add it manually at the bottom of training section as jarredou explained, or forking some previous commit of the original repo is enough.<br>
[OG info follows]
